...
import 'package:food_delivery_flutter/components/my_app_bar.dart';
...
import 'package:food_delivery_flutter/components/my_food_tile.dart';
...
import 'package:food_delivery_flutter/views/food_view.dart';
    ...
    return FoodCategory.values.map((category) {
      ...
      return ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return FoodTile(food: food, onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context) => FoodView(food: food))));
          });
    }).toList();
  }
